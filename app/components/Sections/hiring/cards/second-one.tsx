...
// SecondDisplayCards.tsx
export default function SecondDisplayCards() {
  const cardsConfig: DisplayCardProps[] = [
    {
      title: "Frontend Frameworks",
      description: "React, Next.js, Remix, Astro.",
      date: "Core stack",
      className:
    ...
    {
      title: "Styling & UI",
      description: "Tailwind, Shadcn, Framer Motion.",
      date: "UI layer",
      className:
    ...
    {
      title: "Backend & APIs",
      description: "Node, Express, REST, GraphQL.",
      date: "Server side",
      className:
